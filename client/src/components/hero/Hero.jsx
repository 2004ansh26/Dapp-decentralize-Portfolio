...
const Hero = ({state}) => {
    ...
    useEffect(()=>{
        ...
        const cidOfImage=async()=>{
          const cid = await contract.methods.myImage().call();
          setCid(cid);
        }
        contract && cidOfImage();
      },[state])
        ...
        <div className="container">
                    ...
                    <ModalBody>
                            <Row className="text-align">
                                <label htmlFor="" toggle={() => setModal(!modal)}>
                                    Mail Id - prajapatiansh137@gmail.com
                                </label>
            ...
            <div className="hero-img">
                ...
                <div className="img-container">
                    <img src={`https://emerald-delicate-pig-956.mypinata.cloud/ipfs/${cid}`} alt="profilePhoto" />
                </div>
            </div>
        </div>
    </section>
